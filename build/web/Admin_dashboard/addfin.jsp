   ...
   <script>
       function f() {
           let d = document.getElementById("d").value;
                let f = d*5;
                document.getElementById("fi").value = f;
            }
            </script>
</head>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title"> Add Fine </h3>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Forms</a></li>
                <li class="breadcrumb-item active" aria-current="page">Add Fine</li>
              </ol>
            </nav>
          </div>
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="addfine.jsp">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Issue Id</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" name="id" placeholder="id">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Returned Date</label>
                      <input type="date" class="form-control" id="rd" name="returnd" placeholder="returnd">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">Day</label>
                      <input type="text" class="form-control" id="d" name="day"
                        placeholder="day">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">Fine</label>
                      <input type="text" class="form-control" id="fi" name="fine"
                             placeholder="fine" onclick="f()">
                    </div>
                    <button type="submit" class="btn btn-primary mr-2">Add Fine</button>
                  </form>
                </div>
              </div>
            </div>
