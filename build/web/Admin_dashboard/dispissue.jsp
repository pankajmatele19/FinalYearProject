...
<html lang="en">
    ...
    <body>
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="page-header">
                            <h3 class="page-title"> Manage Issues </h3>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table" id="issue_data">
                                                <thead>
                                                    <tr>
                                                        <%
                                                            try {
                                                                ...
                                                                String sql = "{call LastYearProject.dispiss(?,?,?,?,?,?,?,?)}";
                                                                ...
                                                                while (rs.next()) {
                                                                    ...
                                                                    out.println("<tr><td>" + id + "</td><td>" + userid + "</td><td>" + n + "</td><td>" + bid + "</td><td>" + isd + "</td><td>" + rtd + "</td><td>" + "<label class='badge badge-success'>" + s + "</label></td><tr>");
                                                                }
                                                            } catch (Exception e) {
        ...
        <script>
            ...
            {
                var data = document.getElementById('issue_data');

                var file = XLSX.utils.table_to_book(data, {sheet: "sheet1"});

                XLSX.write(file, {bookType: type, bookSST: true, type: 'base64'});

                XLSX.writeFile(file, 'Issueinfo.' + type);
            }
