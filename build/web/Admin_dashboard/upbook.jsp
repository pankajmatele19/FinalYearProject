            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="updatebook.jsp"> 
                    <div class="form-group">
                      <label for="exampleInputEmail1">Book Id</label>
                      <% int id = Integer.parseInt(request.getParameter("bid"));%>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="bookid" value=<%=id%> placeholder="bid">
                    </div>
<!--                    <div class="form-group">
                      <label for="exampleInputPassword1">Book Name</label>
                      <input type="password" class="form-control" id="exampleInputPassword1" placeholder="bn">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">Author</label>
                      <input type="password" class="form-control" id="exampleInputConfirmPassword1"
                        placeholder="au">
                    </div>-->
                    <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Quantity</label>
                        <input type="text" class="form-control" id="exampleInputConfirmPassword1" name="q"
