            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> Book Requests </h3>
                                ...
                                <div class="table-responsive">
                                  <table class="table">
                                    ...
                                    try {
                                        ...
                                        String sql = "{call LastYearProject.dispreq(?,?,?,?)}";
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.println("<tr><td>" + bid + "</td><td>" + uid + "</td><td>" + n + "</td><td>" + "<a href='addiss.jsp?uid=" +uid+ "&bid="+bid+"'><button class='btn btn-primary'>Approve</button></a>" + "</td><tr>");
                                        }
                                    } catch (Exception e) {
