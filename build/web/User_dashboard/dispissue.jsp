                    ...
                    <li class="nav-item menu-items">
                        ...
                        <div class="collapse" id="ui-basic1">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="Payment.jsp">Display Issues</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item menu-items">
                                ...
                                <div class="table-responsive">
                                  <table class="table">
                                    ...
                                    try {
                                        ...
                                        String sql = "{call LastYearProject.dispuserissue(?,?,?,?,?,?,?)}";
                                        ...
                                        while (rs.next()) {
                                            ...
                                            Date isd = rs.getDate(4);
                                            Date rtd = rs.getDate(5);
            out.println("<tr><td>" + id + "</td><td>" + bid + "</td><td>" + bn + "</td><td>" + isd + "</td><td>" + rtd + "</td><td><label class='badge badge-success'>Issued</label></td><tr>");
                                        }
                                    } catch (Exception e) {
