        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <form class="forms-sample" action="pay.jsp">
                    <div class="form-group">
                        <% String fine = request.getParameter("am"); %>
                        <% String fid = request.getParameter("fid"); %>
                      <label for="exampleInputUsername1">Fine Id</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" name="fid" value=<%=fid%> >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Amount</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" name="amt" value=<%=fine%> >
                    </div>
