...
public final class dispreq_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      out.write("                                       ");
                                    ...
                                    try {
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.println("<tr><td>" + uid + "</td><td>" + bid + "</td><td>" + n + "</td><td>" + "<a href='delfine.jsp?fid=" +uid+ "'><button class='btn btn-danger'>Delete</button></a>" + "</td><tr>");
                                        }
                                    } catch (Exception e) {
