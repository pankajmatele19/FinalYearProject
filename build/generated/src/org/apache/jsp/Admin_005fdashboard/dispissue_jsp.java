...
public final class dispissue_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String name = (String) session.getAttribute("username"); 
      ...
      out.write("                        <h3 class=\"page-title\"> Manage Issues </h3>\n");
      out.write("                        <nav aria-label=\"breadcrumb\">\n");
      out.write("                            <ol class=\"breadcrumb\">\n");
      out.write("                                <li class=\"breadcrumb-item\"><a href=\"#\">Forms</a></li>\n");
      out.write("                                <li class=\"breadcrumb-item active\" aria-current=\"page\">Manage Issues</li>\n");
      out.write("                            </ol>\n");
      out.write("                        </nav>\n");
      out.write("                    </div>\n");
      ...
      out.write("                                <h4 class=\"card-title\">Issue</h4>\n");
      out.write("                                </p>\n");
      ...
      out.write("                                    ");
                                    ...
                                    try {
                                        ...
                                        String sql = "{call ADBMSproject.dispissue(?,?,?,?,?,?,?)}";
                                        ...
                                        while (rs.next()) {
                                            int issid = rs.getInt(1);
                                            int userid = rs.getInt(2);
                                            String n = rs.getString(3);
                                            int bid = rs.getInt(4);
                                            Date isd = rs.getDate(5);
                                            Date rtd = rs.getDate(6);
            out.println("<tr><td>" + issid + "</td><td>" + userid + "</td><td>" + n + "</td><td>" + bid + "</td><td>" + isd + "</td><td>" + rtd + "</td><td>" + "<a href='delissue.jsp?isid=" + issid + "'><button class='btn btn-danger'>Delete</button></a>" + "</td><tr>");
                                        }
                                    } catch (Exception e) {
