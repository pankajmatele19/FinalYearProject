...
<html lang="en">
    ...
    <body>
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item menu-items">
                        ...
                        <div class="collapse" id="ui-basic5">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="Payment.jsp">My Payments</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="page-header">
                            <h3 class="page-title"> Manage Fine </h3>
                            <nav aria-label="breadcrumb">
                                <span><button class="btn btn-primary" id="export">Export</button></span>
                            </nav>
                        </div>
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table" id="fine_data">
                                                <thead>
                                                    <tr>
                                                        <%
                                                            try {
                                                                ...
                                                                String sql = "{call LastYearProject.dispfine(?,?,?,?,?,?,?)}";
                                                                ...
                                                                out.print("<th>Fine Id</th>");
                                                                out.print("<th>Issue Id</th>");
                                                                ...
                                                                while (rs.next()) {
                                                                    ...
                                                                    Date rtd = rs.getDate(3);
                                                                    int d = rs.getInt(4);
                                                                    String f = rs.getString(5);
                                                                    String st = rs.getString(6);
                                                                    if(st.equalsIgnoreCase("pending")) { 
                                                                    out.println("<tr><td>" + fid + "</td><td>" + n + "</td><td>" + rtd + "</td><td>" + d + "</td><td>" + f + "</td><td>" + "<label class='badge badge-danger'>" + st + "</label></td><tr>");
                                                                    }
                                                                    else {
                                                                        out.println("<tr><td>" + fid + "</td><td>" + n + "</td><td>" + rtd + "</td><td>" + d + "</td><td>" + f + "</td><td>" + "<label class='badge badge-success'>" + st + "</label></td><tr>");
                                                                    }
                                                                }
        ...
        <script>
            ...
            {
                var data = document.getElementById('fine_data');

                var file = XLSX.utils.table_to_book(data, {sheet: "sheet1"});

                XLSX.write(file, {bookType: type, bookSST: true, type: 'base64'});

                XLSX.writeFile(file, 'Fineinfo.' + type);
            }
