            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="addissue.jsp"> 
                    <div class="form-group">
                        <% int uid = Integer.parseInt(request.getParameter("uid")); %>
                      <label for="exampleInputUsername1">User Id</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" name="uid" value=<%=uid%> style="background-color: #2A3038">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Book Id</label>
                      <% int bid = Integer.parseInt(request.getParameter("bid")); %>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="bid" value=<%=bid%> style="background-color: #2A3038">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Issue Date</label>
                      <input type="date" class="form-control" id="exampleInputPassword1" name="isd" placeholder="issue date">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">Return Date</label>
                      <input type="date" class="form-control" id="exampleInputConfirmPassword1" name="retd"
                        placeholder="rtd">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">Status</label>
                      <input type="text" class="form-control" id="exampleInputConfirmPassword1" name="stus"
                        placeholder="yes or no">
                    </div>
                    <button type="submit" class="btn btn-primary mr-2">Add Issue</button>
                  </form>
                </div>
              </div>
            </div>
