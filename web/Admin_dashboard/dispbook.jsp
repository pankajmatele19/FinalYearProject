...
<html lang="en">
    ...
    <body>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table" id="book_data">
                                                <thead>
                                                    <tr>
                                                        <%
                                                            try {
                                                                ...
                                                                while (rs.next()) {
                                                                    ...
                                                                    out.println("<tr><td>" + "<img  src='images/" + img + "' style='width: 100px; height: 100px;'>" + "</td><td>" + bid + "</td><td>" + na + "</td><td>" + Author + "</td><td>" + quan + "</td><td>" + dept + "</td><td>" + "<a href='upbook.jsp?bid=" + bid + "&q=" + quan + "'><button class='btn btn-primary'>Update</button></a>" + "   " + "<a href='delbook.jsp?bookid=" + bid + "'><button class='btn btn-danger'>Delete</button></a>" + "</td><tr>");
        ...
        <script>
            ...
            {
                var data = document.getElementById('book_data');

                var file = XLSX.utils.table_to_book(data, {sheet: "sheet1"});

                XLSX.write(file, {bookType: type, bookSST: true, type: 'base64'});

                XLSX.writeFile(file, 'Bookinfo.' + type);
            }
