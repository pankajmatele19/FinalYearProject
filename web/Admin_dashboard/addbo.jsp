            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="addbook.jsp">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Book Name</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" name="bname" placeholder="name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Author</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="author" placeholder="author name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Quantity</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" name="quan" placeholder="quantity">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">Department</label>
                      <input type="text" class="form-control" id="exampleInputConfirmPassword1" name="dept"
                        placeholder="department">
                    </div>
                      <div class="form-group">
                      <label for="exampleInputUsername1">Book Name</label>
                      <input type="file" class="form-control" id="exampleInputUsername1" name="img" placeholder="Select Book Image">
                    </div>
