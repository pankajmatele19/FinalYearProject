                                ...
                                <div class="table-responsive">
                                  <table class="table">
                                    ...
                                    try {
                                        ...
                                        cs.setString(6, (String) session.getAttribute("user"));
                                        ...
                                        while (rs.next()) {
                                            int pi = rs.getInt(1);
                                            int isd = rs.getInt(2);
                                            Date payd = rs.getDate(3);
                                            int f = rs.getInt(4);
                                            
                                            out.println("<tr><td>" + pi + "</td><td>" + isd + "</td><td>" + payd + "</td><td>" + f + "</td><tr>");
                                        }
                                    } catch (Exception e) {
