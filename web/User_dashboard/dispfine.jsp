                                ...
                                <div class="table-responsive">
                                  <table class="table">
                                    ...
                                    try {
                                        ...
                                        String sql = "{call LastYearProject.dispuserfine(?,?,?,?,?,?,?,?)}";
                                        ...
                                        cs.setString(8, (String) session.getAttribute("user"));
                                        cs.executeQuery();
                                        ...
                                        while (rs.next()) {
                                            ...
                                            int d = rs.getInt(4);
                                            String fin = rs.getString(5);
                                            String st = rs.getString(6);
                                            if(st.equalsIgnoreCase("PAID")) {
                                                
                                            out.println("<tr><td>" + fi + "</td><td>" + un + "</td><td>" + rtd + "</td><td>" + d + "</td><td>" + fin + "</td><td>" + "<label class='badge badge-success'>" + st + "</label></td><td>" + "<a href='Payment.jsp?am="+fin+"&fid="+ fi +"'><button class='btn btn-primary' disabled>Pay</button></a>" + "</td><tr>");
                                            }
                                            else {
                                                out.println("<tr><td>" + fi + "</td><td>" + un + "</td><td>" + rtd + "</td><td>" + d + "</td><td>" + fin + "</td><td>" + "<label class='badge badge-danger'>" + st + "</label></td><td>" + "<a href='Payment.jsp?am="+fin+"&fid="+ fi +"'><button class='btn btn-primary'>Pay</button></a>" + "</td><tr>");
                                            }
                                            }
                                    } catch (Exception e) {
